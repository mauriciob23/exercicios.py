...
def cadastrar():
    ...
    modelo = input("Modelo: ")
    marca = input("Marca: ")
    sql = f""" INSERT INTO veiculos VALUES (null, '{modelo}', '{marca}'); """
    cursor.execute(sql)
    conexao.commit()
    print("INSERIDO COM SUCESSO!\n")

while True:
    print("========== CATALOGO DE VEÍCULOS ==========")
...
# def pesquisar():
#     print("========== PESQUISAR VEICULO ==========")
#     pesq = input("Digite a pesquisa: ")
#     sql = f""" SELECT * FROM veiculos WHERE autor LIKE '%{pesq}%' OR titulo LIKE '%{pesq}%' """
#     cursor.execute(sql)
